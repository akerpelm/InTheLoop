export const modalInformation = `<div>
 ...
 <h4 id="wiki-search">Search</h4>
   <ul>
     ...
     <li>An auto populate feature has been implemented, allowing for search by ticker (ie: "MSF" or "MSFT" will auto populate ), or by name ("Micr" or "Microsoft" will auto populate)
 ...
 <h4 id="wiki-charts">Charts</h4>
   <ul>
     <li>The charts on the right are displayed from smallest to largest time frame.</li>
 ...
 <ul>
     ...
     <li>The APIs used to gather data are free versions, meaning there is a limit to the requests that can be made to data per day. As a result, the application does not show real time data, after-hours trading, or all of the information that is desired on the chart (trading volume, TA). This would involve more requests than allowed on a free plan of the APIs.</li>
